...
class ZorkEmulator:
    ...
    SYSTEM_PROMPT = (
        ...
        "- Keep narration concise by default (roughly 2-5 sentences, usually 60-180 words). Only go longer for major turning points.\n"
        ...
        "- Vary prose texture each response while preserving continuity (e.g. clipped, lyrical, procedural, noir, comedic-dry). Do not reuse the exact cadence from the immediately previous narrator turn.\n"
